...
const CardSVG = ({size, name, type, cr}) => (
  <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 227.39 338.51' className={css`display:block;z-index:5;position:relative;`}>
    <defs>
      <clipPath id='a'>
        <rect x='6.95' y='5.75' width='213.42' height='328.48' rx='12' ry='12' fill='none' />
      </clipPath>
    </defs>
    <path d='M221.89.5H5.5a5 5 0 0 0-5 5V333a5 5 0 0 0 5 5h216.39a5 5 0 0 0 5-5V5.5a5 5 0 0 0-5-5zm-1.1 320.9a13 13 0 0 1-13 13H19.53a13 13 0 0 1-13-13V18.24a13 13 0 0 1 13-13h188.26a13 13 0 0 1 13 13z' fill='#000' stroke='#000' strokeMiterlimit='10' />
    <g clipPath='url(#a)'>
    ...
    <svg x='190' y='260' width='29.31' height='32.82'><use xlinkHref='#srd-5e' /></svg>
    <MonsterCR rating={cr} />
  </svg>
)
